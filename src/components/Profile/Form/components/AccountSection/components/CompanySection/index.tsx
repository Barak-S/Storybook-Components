...
export const ProfileFormAccountSectionCompanySection: FC<Props> = ({ style }) => {
...
export type ProfileFormAccountSectionCompanySectionProps = Props;
export default ProfileFormAccountSectionCompanySection;
