...
export const processChangelogCmd = (command: string[], args: Record<string, any>, { cwd, logLevel }: CLIOpts) => {
  try {
...
const getChangelogSectionsWithVersonNamePattern = (changelog: Changelog, versionName: string): ChangelogSection[] => {
